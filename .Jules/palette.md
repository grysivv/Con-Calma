...
## 2024-07-03 - [Explicit Disabled States for Custom Buttons]
**Learning:** In SwiftUI, when applying custom backgrounds and foreground colors to buttons, the default `.disabled()` modifier often fails to provide sufficient visual contrast to indicate an inactive state.
