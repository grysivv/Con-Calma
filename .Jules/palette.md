...
## 2026-07-14 - Explicit Disabled State Colors
**Learning:** In SwiftUI, when applying custom backgrounds to buttons, the default .disabled() modifier often fails to provide sufficient visual contrast.
