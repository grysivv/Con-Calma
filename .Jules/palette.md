...
## 2026-07-11 - Explicit Disabled State Colors
**Learning:** In SwiftUI, the default .disabled() modifier often fails to provide sufficient visual contrast for custom buttons.
