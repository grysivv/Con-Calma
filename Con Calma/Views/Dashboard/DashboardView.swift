                            ...
                            HStack(spacing: 12) {
                                Button(action: {
                                    ...
                                    Text("Nauka")
                                        ...
                                        .padding(.vertical, 16)
                                        .background(dueCards.isEmpty ? Color.gray.opacity(0.2) : Color.primary)
                                ...
                                Button(action: {
                                    ...
                                    Text("Wpisywanie")
                                        ...
                                        .frame(maxWidth: .infinity)
                                        .padding(.vertical, 16)
                                        .background(dueCards.isEmpty ? Color.gray.opacity(0.2) : Color.orange.opacity(0.15))
                                        .clipShape(RoundedRectangle(cornerRadius: 16, style: .continuous))
                                }
                                .disabled(dueCards.isEmpty)
                                .buttonStyle(.borderless)
                            ...
                            HStack(spacing: 12) {
                                ...
                                Button(action: {
                                    ...
                                    Text("Szybki")
                                        ...
                                        .frame(maxWidth: .infinity)
                                        .padding(.vertical, 16)
                                        .background(allCardsCount < 6 ? Color.gray.opacity(0.2) : Color.purple.opacity(0.15))
                                        .clipShape(RoundedRectangle(cornerRadius: 16, style: .continuous))
                                }
